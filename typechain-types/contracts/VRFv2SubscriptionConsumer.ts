...
export interface VRFv2SubscriptionConsumerInterface extends utils.Interface {
  functions: {
...
export interface VRFv2SubscriptionConsumer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VRFv2SubscriptionConsumerInterface;
